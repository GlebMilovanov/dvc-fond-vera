import styles from './CertificatePDF.module.css';
...
import certificateBackground from './images/PDF-certificate-backgound.svg';

export const CertificatePDF = ({ years, city, grade, school }) => {
  ...
  return (
    <div className={styles.container}>
      <img
        ...
        alt="оглавление"
      />
      <p className={`${styles.help} ${years < 2 ? styles.helpShort : ''}`}>
        {getHelpText(years)}
      </p>
      <div className={styles.textContainer}>
        ...
        <p className={styles.text}>
          ...
          чтобы расти; другим – аппараты для дыхания, чтобы дышать;
          а&nbsp;третьим – электроколяски, чтобы было легче передвигаться. Но
          абсолютно всем детям и их родителям важно знать, что они не одни.
          Благодаря вам они могут быть в этом уверены.
        </p>
